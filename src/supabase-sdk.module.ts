...
import { ConfigurableModuleClass, MODULE_OPTIONS_TOKEN, SupabaseSdkModuleOptions } from './supabase-sdk.module-definition';
  ...
  providers: [
    {
      ...
      useFactory: (options: SupabaseSdkModuleOptions) => {
        return createClient(options.auth.url, options.auth.key);
      },
